...
<template>
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="shrink-0">
    ...
    <template v-else-if="name === 'profiles'">
    ...
    <template v-else-if="name === 'code-repos'">
      <line x1="6" x2="6" y1="3" y2="15" />
      <circle cx="18" cy="6" r="3" />
      <circle cx="6" cy="18" r="3" />
      <path d="M18 9a9 9 0 0 1-9 9" />
    </template>
    <template v-else-if="name === 'knowledge-config'">
    ...
    <template v-else-if="name === 'workflow'">
      ...
      <path d="M6.5 8v4.5a2 2 0 0 0 2 2h7a2 2 0 0 0 2-2V8" />
