...
from agent_bridge.capabilities.mcp_http_client import (
    McpHttpClient,
...
def test_mcp_http_client_list_tools_handles_pagination(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "agent_bridge.capabilities.mcp_http_client.streamablehttp_client",
        fake_streamablehttp_client,
    )
    monkeypatch.setattr("agent_bridge.capabilities.mcp_http_client.ClientSession", FakeClientSession)
